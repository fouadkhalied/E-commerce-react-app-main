...
const Dellitem =()=>{
   ...
   return(
       <div className='dell-item-div mt-3'>
          ...
          <div className='dell-item-div-sidebar-div'><img onMouseEnter={()=>setx(0)} width="50px" height="40px" src={data101[x3].img[0]}/></div>
          <div className='dell-item-div-sidebar-div'><img onMouseEnter={()=>setx(1)} width="50px" height="40px" src={data101[x3].img[1]}/></div>
          <div className='dell-item-div-sidebar-div'><img onMouseEnter={()=>setx(2)} width="50px" height="40px" src={data101[x3].img[2]}/></div>
          <div className='dell-item-div-sidebar-div'><img onMouseEnter={()=>setx(3)} width="50px" height="40px" src={data101[x3].img[3]}/></div>
          <div className='dell-item-div-sidebar-div'><img onMouseEnter={()=>setx(4)} width="50px" height="40px" src={data101[x3].img[4]}/></div>
          <div className='dell-item-div-sidebar-div'><img onMouseEnter={()=>setx(5)} width="50px" height="40px" src={data101[x3].img[5]}/></div>
          </div> 
